...
export interface Proxy_factoryInterface extends Interface {
    getFunction(nameOrSignature: "calculateCreateProxyWithNonceAddress" | "createProxy" | "createProxyWithCallback" | "createProxyWithNonce" | "proxyCreationCode" | "proxyRuntimeCode"): FunctionFragment;
