...
async function getProxyFactoryContract({ ethAdapter, safeVersion, customContracts }) {
    ...
    const isContractDeployed = await ethAdapter.isContractDeployed(await safeProxyFactoryContract.getAddress());
    if (!isContractDeployed) {
...
async function getCompatibilityFallbackHandlerContract({ ethAdapter, safeVersion, customContracts }) {
    ...
    const isContractDeployed = await ethAdapter.isContractDeployed(await fallbackHandlerContract.getAddress());
    if (!isContractDeployed) {
...
async function getMultiSendCallOnlyContract({ ethAdapter, safeVersion, customContracts }) {
    ...
    const isContractDeployed = await ethAdapter.isContractDeployed(await multiSendCallOnlyContract.getAddress());
    if (!isContractDeployed) {
...
async function getSignMessageLibContract({ ethAdapter, safeVersion, customContracts }) {
    ...
    const isContractDeployed = await ethAdapter.isContractDeployed(await signMessageLibContract.getAddress());
    if (!isContractDeployed) {
...
async function getSimulateTxAccessorContract({ ethAdapter, safeVersion, customContracts }) {
    ...
    const isContractDeployed = await ethAdapter.isContractDeployed(await simulateTxAccessorContract.getAddress());
    if (!isContractDeployed) {
