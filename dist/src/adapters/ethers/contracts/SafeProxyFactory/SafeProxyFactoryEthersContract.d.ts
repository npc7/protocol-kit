...
import { Proxy_factory as SafeProxyFactory_V1_0_0 } from '../../../../../typechain/src/ethers-v6/v1.0.0/Proxy_factory';
import { Proxy_factory as SafeProxyFactory_V1_1_1 } from '../../../../../typechain/src/ethers-v6/v1.1.1/Proxy_factory';
import { Proxy_factory as SafeProxyFactory_V1_3_0 } from '../../../../../typechain/src/ethers-v6/v1.3.0/Proxy_factory';
import { Safe_proxy_factory as SafeProxyFactory_V1_4_1 } from '../../../../../typechain/src/ethers-v6/v1.4.1/Safe_proxy_factory';
...
declare class SafeProxyFactoryEthersContract implements SafeProxyFactoryContract {
    ...
    createProxy({ safeSingletonAddress, initializer, saltNonce, options, callback }: CreateProxyProps): Promise<string>;
